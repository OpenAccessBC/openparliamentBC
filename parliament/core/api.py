...
class APIFilters():
    ...
    def dbfield(field_name: str | None = None, filter_types=None, help_txt=None):
        ...
        def inner(qs: QuerySet, view: "ModelListView", filter_name: str, filter_extra: str, val: str) -> QuerySet:
            if not filter_extra:
                filter_extra = 'exact'
    ...
    def choices(field_name: str, model):
        ...
        def inner(qs: QuerySet, view: "ModelListView", filter_name: str, filter_extra: str, val) -> QuerySet:
            try:
...
class ModelListView(APIView):
    ...
    def filter(self, request: HttpRequest, qs: QuerySet) -> QuerySet:
